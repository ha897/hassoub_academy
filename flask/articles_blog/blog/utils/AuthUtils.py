...
def subscriber_plot():
    # list_sub_year = db.session.query(func.date(StripeCustomer))
    #[(datetime.date(2023, 1, 28), 10), (datetime.date(2022, 9, 24), [22), (datetime.date(2022, 11, 17), 1)]
    ...
    fig = go.Figure()
    fig.add_trace(go.Scatter(x=x_year, y=y_year, line_shape='spline', name="اشتراك سنوي"))
    fig.add_trace(go.Scatter(x=x_month, y=y_month, line_shape='spline', name="اشتراك شهري"))
